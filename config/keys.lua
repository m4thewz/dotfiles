...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ mod }, "z", function() awful.layout.inc(1) end,
    { description = "next layout", group = "awesome" }),
  awful.key({ mod, "Shift" }, "z", function() awful.layout.inc(-1) end,
  ...
  awful.key({ mod }, "space",
    function() awful.util.spawn("rofi -show drun -theme " .. home .. "/.config/rofi/launcher.rasi") end,
    { description = "show menu", group = "awesome" }),
  awful.key({ mod }, "d", function() awesome.emit_signal("widget::launcher") end,
    { description = "show launcher", group = "awesome" }),
  awful.key({ mod, "Shift" }, "c", function() awesome.emit_signal("widget::config") end,
    { description = "show config", group = "awesome" }),

  -- Programs
  awful.key({ mod }, "Return", function() awful.spawn.with_shell("kitty") end,
    { description = "open a terminal", group = "programs" }),
  awful.key({ mod }, "p", function() awesome.emit_signal("powermenu:show") end,
  ...
  awful.key({}, "XF86AudioPrev", sendToSpotify("Previous"),
    { description = "previous", group = "volume" }),
  awful.key({}, "XF86AudioNext", sendToSpotify("Next"),
    { description = "next", group = "volume" }),
  awful.key({}, "XF86AudioPlay", sendToSpotify("PlayPause"),
    { description = "toggle play pause", group = "volume" }),
  awful.key({}, "XF86AudioStop", sendToSpotify("Pause"),
    { description = "stop audio", group = "volume" }),
...
client.connect_signal("request::default_keybindings", function()
  awful.keyboard.append_client_keybindings({
    -- Client
    awful.key({ mod }, "c", function(c) awful.placement.centered(c, { honor_workarea = true }) end,
    ...
    awful.key({ mod }, "n", function() client.focus.minimized = true end,
